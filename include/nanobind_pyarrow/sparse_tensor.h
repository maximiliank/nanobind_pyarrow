/*
    nanobind_pyarrow/sparse_tensor.h: conversion between arrow and pyarrow
...
template<typename T>
struct pyarrow_sparse_coo_tensor_caster
    : pyarrow_caster<T, arrow::py::is_sparse_coo_tensor, arrow::py::wrap_sparse_coo_tensor,
              arrow::py::unwrap_sparse_coo_tensor> {};

template<typename T>
struct pyarrow_sparse_csc_matrix_caster
    : pyarrow_caster<T, arrow::py::is_sparse_csc_matrix, arrow::py::wrap_sparse_csc_matrix,
              arrow::py::unwrap_sparse_csc_matrix> {};

template<typename T>
struct pyarrow_sparse_csf_tensor_caster
    : pyarrow_caster<T, arrow::py::is_sparse_csf_tensor, arrow::py::wrap_sparse_csf_tensor,
              arrow::py::unwrap_sparse_csf_tensor> {};

template<typename T>
struct pyarrow_sparse_csr_matrix_caster
    : pyarrow_caster<T, arrow::py::is_sparse_csr_matrix, arrow::py::wrap_sparse_csr_matrix,
              arrow::py::unwrap_sparse_csc_matrix> {};
